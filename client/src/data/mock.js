...
const RAW = [
  ...
  },
  {
    ...
    model: 'https://modelviewer.dev/shared-assets/models/DamagedHelmet.glb',
    discountPercent: 20
  },
  {
    id: 'prod-3',
    ...
    image: 'https://images.unsplash.com/photo-1546776230-bb86256870ce?w=400&q=80',
  ...
  },
  {
    ...
    model: 'https://modelviewer.dev/shared-assets/models/SheenChair.glb',
    discountPercent: 10
  },
  {
    id: 'prod-5',
    name: 'Hamburguesa Réplica XL',
    description: 'Réplica realista de hamburguesa para decoración. Detalle increíble en cada capa.',
    price: 14990,
    stock: 8,
  ...
  },
  {
    ...
    description: 'Variante dorada del astronauta coleccionable. Tirada numerada de 100 unidades.',
    price: 49990,
    stock: 3,
    categoryId: 'cat-games',
    image: 'https://images.unsplash.com/photo-1457364887197-9150188c107b?w=400&q=80',
    model: 'https://modelviewer.dev/shared-assets/models/Astronaut.glb',
    discountPercent: 30
  }
]
...
function withDiscount(p) {
  ...
  const discountedPrice = active ? Math.round(p.price * (1 - p.discountPercent / 100)) : p.price
  return {
    ...p,
